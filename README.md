...
> 현재 상태: **네비게이션/스크롤 인터랙션 구현 — 사용자 검토 대기**
>
> HTML, 반응형 스타일, 메뉴와 스크롤 인터랙션을 구현했습니다. 테마 토글, 폼 검증, API는 후속 단계에서 구현합니다.
...
화면 폭을 모바일(예: 390px), 태블릿(768px), 데스크톱(1024px 이상)으로 바꿔 배치와 가로 넘침을 확인합니다. 버튼/카드 hover, Tab 키 초점 표시, 입력 폼도 확인합니다. 메뉴는 아래 순서로 확인합니다. 테마 토글은 후속 단계입니다.
...
폼 제출과 다크 모드 토글은 이번 단계 확인 대상이 아닙니다. 폼 제출은 여전히 비활성화 상태입니다.
